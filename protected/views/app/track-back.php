 ...
 <div class="content_main">
   ...
   <div class="nav_option">
      <div class="row">
        <div class="col-md-6 border">
         <b><?php echo t("Agents Track Back")?></b>
        </div> <!--col-->        
      </div> <!--row-->
   </div> <!--nav_option-->
   ...
   <form id="frm" class="frm form-horizontal">
    ...
    <div class="row">
       ...
       <div class="col-md-2">
         <a href="javascript:;" class="btn btn-success track_replay"><?php echo t("Replay")?></a>
       </div>
