   ...
   <div class="spinner">
    ...
    <div class="row"> 
      ...
      <div class="col-xs-5" style="padding-left:0;"> 
        <p class="agent-name"><?php echo $data['driver_name']?><br/>
        <span><?php echo t("Your Agent")?></span><br/>
        <span style="font-size:11px;"><?php echo t("Task ID").": ".$data['task_id']?></span>
        </p>
      </div>
      ...
      <div class="col-xs-4 text-right">
        <div class="eta-wrap">
        <p><?php echo t("ETA")?><br/>
        <b class="track_eta">00 Mins</b><br/>
        <span class="task-status""><?php echo t("Task Status")?> : 
          <b class="task-stats"><?php echo t($data['status'])?></b>
        </span>
        </p>
        </div> <!--eta-wrap-->
...
$icon_driver='//maps.google.com/mapfiles/ms/micons/red.png';
$icon_dropoff='//maps.google.com/mapfiles/ms/micons/blue.png';
$icon_finish='//maps.google.com/mapfiles/ms/micons/orange-dot.png';
